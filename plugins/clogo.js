...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'clogo', fromMe: true, desc: EFFECT_DESC}, (async (message, match) => {    
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*░▒▓█►─═ Ćн𝕒𝐌Ꭵy𝕒  𝒷𝕆Ŧ═─◄█▓▒░*'})
    ...
    Asena.addCommand({pattern: 'clogo', fromMe: false, desc: EFFECT_DESC}, (async (message, match) => {    
